...
[Example](https://fsunuc.physics.fsu.edu/git/gwm17/implot/src/commit/e0450d00af0cad3ba73f973a6efb069bddd39da6/README.md)
[Example](https://github.com/epezent/implot_demos/blob/master/screenshots/spectrogram.png)
...
2. Sending config & Simulated data stream 
A python script which on connection to the dashboard sends the config file to the dashboard, then begins streaming telemetry packets at a fixed rate over TCP. 
